...
class Deformation(nn.Module):
    ...
    def create_net(self):
        ...
        self.feature_out = nn.Sequential(*self.feature_out) # feature from hexplane grid that is fed into the deformation MLPs
    ...
    def forward(self, rays_pts_emb, scales_emb=None, rotations_emb=None, opacity = None,shs_emb=None, time_feature=None, time_emb=None, anchor_gaussians=None):
        # Displacement field ignores anchor_gaussians (only velocity field uses them)
        if time_emb is None:
...
class deform_network(nn.Module):
    ...
    def forward(self, point, scales=None, rotations=None, opacity=None, shs=None, times_sel=None, anchor_gaussians=None):
        # Displacement field ignores anchor_gaussians (only velocity field uses them)
